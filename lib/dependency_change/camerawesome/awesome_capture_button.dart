...
class AwesomeCaptureButton1 extends StatefulWidget {
  final CameraState state;
  final Function(CaptureRequest)? onPhoto;
  const AwesomeCaptureButton1({
    super.key,
    required this.state,
    this.onPhoto,
  });
  ...
  @override
  _AwesomeCaptureButton1State createState() => _AwesomeCaptureButton1State();
}

class _AwesomeCaptureButton1State extends State<AwesomeCaptureButton1>
  ...
  get onTap => () {
    widget.state.when(
      onPhotoMode: (photoState) => photoState.takePhoto(onPhoto: widget.onPhoto),
