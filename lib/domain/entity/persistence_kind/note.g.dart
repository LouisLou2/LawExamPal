...
extension NoteByIndex on IsarCollection<Note> {
  Future<Note?> getByTime(DateTime time) {
    return getByIndex(r'time', [time]);
  }

  Note? getByTimeSync(DateTime time) {
  ...
  Future<List<Note?>> getAllByTime(List<DateTime> timeValues) {
    final values = timeValues.map((e) => [e]).toList();
    return getAllByIndex(r'time', values);
  }

  List<Note?> getAllByTimeSync(List<DateTime> timeValues) {
    final values = timeValues.map((e) => [e]).toList();
  ...
  Future<Id> putByTime(Note object) {
    return putByIndex(r'time', object);
  }

  Id putByTimeSync(Note object, {bool saveLinks = true}) {
    return putByIndexSync(r'time', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByTime(List<Note> objects) {
    return putAllByIndex(r'time', objects);
  }

  List<Id> putAllByTimeSync(List<Note> objects, {bool saveLinks = true}) {
...
extension NoteQueryWhereSort on QueryBuilder<Note, Note, QWhere> {
  ...
  QueryBuilder<Note, Note, QAfterWhere> anyTime() {
    return QueryBuilder.apply(this, (query) {
...
extension NoteQueryWhere on QueryBuilder<Note, Note, QWhereClause> {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> timeEqualTo(DateTime time) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> timeNotEqualTo(DateTime time) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> timeGreaterThan(
    DateTime time, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> timeLessThan(
    DateTime time, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Note, Note, QAfterWhereClause> timeBetween(
    DateTime lowerTime,
    DateTime upperTime, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension NoteQueryFilter on QueryBuilder<Note, Note, QFilterCondition> {
  ...
  QueryBuilder<Note, Note, QAfterFilterCondition> userIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'userId',
        value: value,
...
extension NoteQueryProperty on QueryBuilder<Note, Note, QQueryProperty> {
  ...
  QueryBuilder<Note, int, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
